...
contract MoodNft is ERC721 {
    ...
    function tokenURI(
        ...
        string memory tokenURIreturned = string(
            abi.encodePacked(_baseURI(), Base64.encode(tokenMetadata))
        );
        return tokenURIreturned;
    }

    function getSadSvgImagegUri() public view returns (string memory) {
        return s_sadSvgImageUri;
    }

    function getHappySvgImagegUri() public view returns (string memory) {
